...
def get_products_with_discount(user_id: str, products_srv: ProductsStub = Depends(get_products_service),
...
def get_product_with_discount(user_id: str, product_id: str,
                              products_srv: ProductsStub = Depends(get_products_service),
                              discount_srv: DiscounterStub = Depends(get_discount_service),
                              users_srv: UsersStub = Depends(get_users_service)):
    user = repositories.get_user(users_srv, user_id)
